...
def startEncryption():
    ...
    btn_create = Button(encryption_window, text = "Create", font = 'arial 13', command = saveData, bg = "#F5DEB3", relief = FLAT)
...
heading_label = Label(root, text = "Encryption & Decryption", font = 'arial 18 italic', bg = "#99c787")
heading_label.place(relx = 0.5, rely = 0.2, anchor = CENTER)

btn_start_encryption = Button(root, text = "Start Encryption", font = 'arial 13', command = startEncryption,  relief = FLAT)
btn_start_encryption.place(relx = 0.3, rely = 0.6, anchor = CENTER)

btn_start_decryption = Button(root, text = "Start Decryption", font = 'arial 13', command = startDecryption,  relief = FLAT)
